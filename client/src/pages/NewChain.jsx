...
export default function NewChain() {
  ...
  const [nodes, setNodes] = useState([{ id: uuidv4(), text: "" }]);
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-md rounded-lg">
      ...
      {errors.nodes && (
        <p className="text-red-500 text-sm mb-1">{errors.nodes}</p>
      )}
      {errors.nodeText && (
        <p className="text-red-500 text-sm mb-4">{errors.nodeText}</p>
      )}
